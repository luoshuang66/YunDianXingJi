// src/app/frontend/user/login/page.tsx
'use client';
      ...
      <div className="w-full max-w-md relative mx-auto">
        ...
        <div className="relative bg-white p-8 rounded-2xl shadow-lg animate-fade-in">
          ...
          <div className="text-center mb-8">
            ...
            <h2 className="text-2xl font-bold text-emerald-800 mb-2">账号登录</h2>
            <div className="w-24 h-1 bg-emerald-300 mx-auto"></div>
          </div>

          <div className="space-y-6">
            <div>
              <label className="block text-emerald-700 font-medium mb-2">手机号/邮箱</label>
              <input
                type="text"
            ...
            <div className="flex justify-between items-center">
              ...
              <p className="text-sm text-emerald-600">
                还没有账号？
                <Link href="/frontend/user/register" className="text-emerald-800 font-medium ml-1">立即注册</Link>
              </p>
            </div>
          </div>
        </div>
